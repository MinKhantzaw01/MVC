            ...
            <div class="card bg-light p-5">
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control rounded-0" id="username" aria-describedby="username" name="username" >
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control rounded-0" id="confirm_password" aria-describedby="password" name="confirm_password">
                    </div>
